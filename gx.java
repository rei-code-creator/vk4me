final class gx extends jr {
  private final int a;
  
  gx(String paramString, int paramInt) {
    super(paramString);
    this.a = paramInt;
  }
  ...
  public final void c() {
    ...
    //   186: aload_1
    //   187: aload_2
    //   188: invokespecial <init> : (Ljava/util/Vector;Lgh;)V
...
/* Location:              /home/kost/Загрузки/latest.jar!/gx.class
