public final class ln extends es {
  private static Class a;
  
  public ln() {
    super((a == null) ? (a = a("ai")) : a, "groups.get");
    a("extended", 1);
  ...
  private ln(int paramInt) {
    this();
    a("user_id", paramInt);
  }
  
  public ln(int paramInt1, int paramInt2) {
    this(paramInt1);
    a("count", 20);
    paramInt1 = paramInt2;
    a("offset", paramInt1);
...
/* Location:              /home/kost/Загрузки/latest.jar!/ln.class
